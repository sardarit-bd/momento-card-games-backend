...
class StripeGateway implements PaymentGatewayInterface
{
    ...
    public function handleWebhook(string $payload, ?string $sigHeader = null)
    {
        ...
        try {
            ...
            //         if ($payment) {
            //             $notes = 'Checkout session expired (user abandoned or canceled).';
            //             if (!empty($session->after_expiration->recovery->url)) {
            ...
            //             new AbandonedCartRecovery($order, $session->after_expiration->recovery->url)
            //         );
            //     }
            // }
            // Session expired (abandoned or canceled)
